...
\begin{equation}\label{sup}
	\delta:=\sup_{P\neq Q} |\bm{\updelta}_{PQ} |
\end{equation}
e consideriamo un'espansione  in serie di Taylor al primo ordine, trascurando tutti i termini di ordine $\delta^2$. Vista la \eqref{sup}, senz'altro
\begin{equation}
